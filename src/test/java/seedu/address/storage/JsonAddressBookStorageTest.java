...
public class JsonAddressBookStorageTest {
    ...
    private java.util.Optional<ReadOnlyFashionMatch> readAddressBook(String filePath) throws Exception {
    ...
    public void readAndSaveAddressBook_allInOrder_success() throws Exception {
        ...
        ReadOnlyFashionMatch readBack = jsonAddressBookStorage.readAddressBook(filePath).get();
        assertEquals(original, new FashionMatch(readBack));
     ...
     */
    private void saveAddressBook(ReadOnlyFashionMatch addressBook, String filePath) {
        try {
    ...
    public void saveAddressBook_nullFilePath_throwsNullPointerException() {
        thrown.expect(NullPointerException.class);
        saveAddressBook(new FashionMatch(), null);
    }
}
