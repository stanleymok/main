...
public class JsonAdaptedApparelTest {
    ...
    private static final String VALID_PHONE = BENSON.getColor().toString();
    private static final String VALID_EMAIL = BENSON.getClothingType().toString();
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        ...
        String expectedMessage = ClothingType.MESSAGE_CONSTRAINTS;
        Assert.assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
