...
* `wash 1` +
Makes available the 1st apparel in the list if it was worn.
* `available 2` +
Does nothing if the 2nd apparel in the list is already clean.
...
* `wear 1` +
Makes worn the 1st apparel in the list.
